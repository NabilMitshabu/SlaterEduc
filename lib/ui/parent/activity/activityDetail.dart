...
import '../punition/historique_punitions.dart';
import '../resultat/resultat.dart';
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => HistoriquePaiementScreen(studentId: widget.eleveId ?? '')),
                        );
                      },
                    ),
                  ],
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => HistoriquePunitionsScreen(studentId: widget.eleveId ?? ''),
                  ),
                );
              },
